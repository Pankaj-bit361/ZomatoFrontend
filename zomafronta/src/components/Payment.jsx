...
e.preventDefault()
axios.get(`${url}/getCheckout/${val[1].email}`)
.then((res)=>{
  console.log(res)
})
    ...
    return (
      <Box className={styles.modal} w="40%" margin={"auto"} mt="5%" mb="5%" >
...
<rect fill="white" height="38.1" width="80"></rect>
          ...
          <Flex className={styles.separator}>
            ...
            <Text>or pay using credit card</Text>
            <hr className={styles.line} />
          </Flex>
  
          <Box className={styles['credit-card-info--form']}>
            <Flex className={styles.input_container}>
              <label htmlFor="cardholder_name" className={styles.input_label}>
            ...
            <Flex className={styles.input_container}>
              <label htmlFor="card_number" className={styles.input_label}>
                Card Number
              </label>
              <Input
                id="card_number"
            ...
            <Flex className={styles.input_container}>
              <label htmlFor="expiry_date" className={styles.input_label}>
                Expiry Date / CVV
              </label>
          ...
          <Button  className={styles['purchase--btn']} onClick={()=>navigate("/successfull")}>Checkout</Button>
        </form>
      </Box>
    );
  };
